...
function SaveButton(
  ...
  return (
    <button  type={type} className="button">
        <span className="button__text">Save Item</span>
        <span className="button__icon"> 
        <svg  xmlns="http://www.w3.org/2000/svg"  className="svg" height="1em" viewBox="0 0 384 512" fill="white"  stroke="currentColor"  className="svg">
